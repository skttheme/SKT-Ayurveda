...
<?php esc_html_e( 'Skip to content', 'skt-ayurveda' ); ?>
</a>
<?php
...
<div class="header">
    <div class="logo">
		<?php skt_ayurveda_the_custom_logo(); ?>
        <div class="clear"></div>
		<?php	
            ...
            <div class="header-right-infos">				
                <div class="header-phone-number">
                    <?php if (!empty($header_phonenumbertext)) { ?>
                        ...
                        <span><?php esc_html_e('Call Us Now','skt-ayurveda');?></span>
                        <a href="<?php echo esc_attr('tel:'. $header_phonenumbertext); ?>"><?php echo esc_html($header_phonenumbertext); ?></a>
                    <?php }?>
                </div>                
            </div>
        <div class="clear"></div>    
